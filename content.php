        ...
        <div>
            <ul class="page_sns_counter">
                <li class="page_fb_counts">
                    <ul><li>
                        <a onclick="javascript:window.open(encodeURI(decodeURI('http://www.facebook.com/sharer.php?src=bm&u=<?php echo $canonical_url_encode;?>&amp;t=<?php echo $title_encode;?>')), '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" class="page_counts_img fade " id="page_fb_counts_img"></a>
                        </li>
                        <li>
                ...
                <li class="page_tw_counts">
                    <ul><li>
                        <a onclick="javascript:window.open(encodeURI(decodeURI('http://twitter.com/intent/tweet?url=<?php echo $canonical_url_encode;?>&text=<?php echo $title_encode; ?>')
                            ), '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" class="page_counts_img fade" id="page_tw_counts_img">
                        </a>
                        </li>
                        <li>
                ...
                <li class="page_hb_counts">
                    <ul><li>
                    <a onclick="javascript:window.open('http://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $canonical_url_encode;?>&title=<?php echo $_title;?>', '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" class="page_counts_img fade" id="page_hb_counts_img">
                        </a>
                    </li>
                        <li>
